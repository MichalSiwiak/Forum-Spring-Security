...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
          type="text/css">
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/neon.css">
</head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 py-4">
                <h4>About</h4>
                <p class="text-info">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
...
<div class="navbar navbar-dark bg-dark">
    <div class="container d-flex justify-content-between">
        <a href="#" class="navbar-brand d-flex align-items-center"><i class="fa d-inline fa-camera mr-2"></i><strong>Album</strong>
        </a>
...
<div class="text-center py-5">
    <div class="container">
        <div class="row my-5 justify-content-center">
            <div class="col-md-9">
                <h1>javacoding.pl album</h1>
                <p class="lead text-muted">Free open source projects present different java solutions using spring,
                    hibernate and other popular frameworks.</p>
            </div>
        </div>
    </div>
</div>
<div class="bg-light py-4" style="	text-shadow: 0px 0px 4px black;	box-shadow: 0px 0px 4px  black;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 p-3">
                <div class="card box-shadow">
                    <div class="card-body rounded bg-info">
                        <h4 class="">Forum Spring Security</h4>
                        <br>
                        <br>
                        <br>
                        <br>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="/index" class="btn btn-dark" target="_blank">Demo</a>
                            </div>
                            <small class="text-light">9 mins</small>
                        </div>
                    </div>
            ...
            <div class="col-md-4 p-3">
                <div class="card box-shadow">
                    <div class="card-body rounded bg-info">
                        <h4 class="">This is a wider card with supporting text below as a natural lead-in to additional
                            content. This content is a little bit longer.</h4>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
...
<footer class="text-muted py-5">
    <div class="container">
        ...
        <p>Album template is based on Bootstrap © examples.&nbsp; <br>New to Bootstrap? <a href="#">Visit the
            homepage</a> or read our <a href="#">getting started guide</a>.</p>
    </div>
</footer>
